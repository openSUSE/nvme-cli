...
static inline int json_object_add_value_string(struct json_object *o,
					       const char *k,
					       const char *v)
{
	return json_object_object_add(o, k,
...
static inline int json_array_add_value_string(struct json_object *o,
					      const char *v)
{
